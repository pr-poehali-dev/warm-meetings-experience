...
def handle_start(chat_id):
    send_message(chat_id,
        "👋 Привет! Я бот СПАРКОМ для публикации ваших событий в Telegram-каналы.\n\n"
        "Чтобы начать:\n"
        "1️⃣ Привяжите аккаунт командой /verify\n"
        "2️⃣ Подключите канал командой /add\n"
        "3️⃣ Готово! Новые события будут автоматически публиковаться.\n\n"
        "/help — все команды")
