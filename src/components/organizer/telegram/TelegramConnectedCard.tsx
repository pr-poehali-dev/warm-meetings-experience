    ...
    <Card className="border-green-500/30 bg-green-500/5 dark:bg-green-500/10">
      <CardContent className="pt-5 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold text-green-800 dark:text-green-400">Всё настроено!</div>
            <div className="text-sm text-green-700 dark:text-green-500">Бот активен и готов к работе</div>
          </div>
        </div>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                <Icon name={item.icon as "Megaphone"} size={14} className="text-green-600 dark:text-green-400 flex-shrink-0" />
                {item.text}
              </div>
            ))}
          </div>
