    ...
    <footer className="bg-foreground text-background/80 mt-auto">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="text-background font-bold text-lg mb-2">
              СПАРКОМ
            </div>
            <p className="text-sm leading-relaxed text-background/60">
              Банный клуб для тех, кто ценит настоящую баню, живое общение и
              правильную компанию.
            </p>
          </div>

          <div>
            <div className="text-background font-semibold text-sm mb-3 uppercase tracking-wider">
              Навигация
            </div>
