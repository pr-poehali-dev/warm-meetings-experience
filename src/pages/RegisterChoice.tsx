      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex flex-col items-center">
        <div className="w-full max-w-lg">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-2">Вы хотите ходить в баню<br />или принимать гостей?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                  Веду расписание, парю, провожу мероприятия
                </p>
              </div>
              <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                <Icon name="ArrowRight" size={18} className="text-primary" />
