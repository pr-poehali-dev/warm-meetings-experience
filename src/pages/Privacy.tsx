...
const SECTIONS = [
  { id: "s1",  title: "Общие положения" },
  { id: "s2",  title: "Основные понятия" },
  { id: "s3",  title: "Права и обязанности Оператора" },
  { id: "s4",  title: "Права субъектов данных" },
  { id: "s5",  title: "Цели сбора и обработки" },
  { id: "s6",  title: "Передача третьим лицам" },
  { id: "s7",  title: "Простая электронная подпись" },
  { id: "s8",  title: "Условия обработки" },
  { id: "s9",  title: "Безопасность данных" },
  { id: "s10", title: "Права на информацию" },
  { id: "s11", title: "Несовершеннолетние" },
  { id: "s12", title: "Трансграничная передача" },
  { id: "s13", title: "Изменение Политики" },
  { id: "s14", title: "Заключительные положения" },
  { id: "s15", title: "Контакты" },
];
...
export default function Privacy() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* ── main layout ──────────────────────────────────────────────────── */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex gap-12 flex-1">
        ...
        {/* content */}
        <article className="flex-1 min-w-0 max-w-3xl space-y-12 text-foreground/90 leading-relaxed">
          ...
          <section id="s12" className="scroll-mt-8">
          ...
          <section id="s13" className="scroll-mt-8">
          ...
          <section id="s14" className="scroll-mt-8">
          ...
          <section id="s15" className="scroll-mt-8">
            ...
            <div className="bg-muted/50 rounded-xl p-6 text-sm space-y-2.5">
              ...
              <div className="pt-1 space-y-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <a href="tel:+79265370200" className="text-primary underline underline-offset-2 hover:text-primary/80">
                    +7 (926) 537-02-00
                  </a>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:club@sparcom.ru" className="text-primary underline underline-offset-2 hover:text-primary/80">
                    club@sparcom.ru
                  </a>
                </div>
              </div>
