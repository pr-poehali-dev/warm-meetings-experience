...
export const FORMATS = [
  ...
  { icon: "GraduationCap", title: "Курсы", desc: "Обучение для пармастеров — техники пара, работа с веником, ведение банных церемоний." },
  { icon: "TreePine", title: "Фестивали", desc: "Ретриты на природе — несколько дней практик, бани и живого общения вдали от города." },
];
