      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mb-16 w-full max-w-md mx-auto px-4">
            <Card className="p-4 sm:p-6 bg-[#229ED9] hover:bg-[#1e8bc3] border-0 shadow-xl hover:shadow-2xl transition-all cursor-pointer"
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-full flex items-center justify-center flex-shrink-0">
                  <svg viewBox="0 0 24 24" className="w-7 h-7 sm:w-8 sm:h-8" fill="#229ED9">
                ...
                <div className="text-left min-w-0 flex-1">
                  ...
                  <div className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                    ...
                    <Icon name="ExternalLink" className="flex-shrink-0" size={16} />
                  </div>
                </div>
              </div>
            </Card>
