        ...
        <div className="flex gap-12">
          ...
          <article className="flex-1 min-w-0 max-w-3xl prose prose-sm prose-neutral dark:prose-invert prose-headings:font-semibold prose-headings:text-foreground prose-p:text-foreground/80 prose-li:text-foreground/80 prose-a:text-primary max-w-none">
            ...
            <section id="s2" className="scroll-mt-20 mb-10">
              <h2 className="text-xl font-semibold text-foreground mb-3">2. Описание функциональных характеристик</h2>
            ...
            <section id="s21" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.1. Общий функционал для всех ролей</h3>
            ...
            <section id="s22" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.2. Роль «Участник» (Посетитель)</h3>
              <ul className="space-y-1.5 text-foreground/80">
            ...
            <section id="s23" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.3. Роль «Партнёр (Баня)» — Владелец или менеджер банного комплекса</h3>
              <ul className="space-y-1.5 text-foreground/80">
            ...
            <section id="s24" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.4. Роль «Мастер»</h3>
              <ul className="space-y-1.5 text-foreground/80">
            ...
            <section id="s25" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.5. Роль «Организатор мероприятий»</h3>
              <ul className="space-y-1.5 text-foreground/80">
            ...
            <section id="s26" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.6. Функционал Администратора платформы</h3>
              <ul className="space-y-1.5 text-foreground/80">
            ...
            <section id="s27" className="scroll-mt-20 mb-10">
              <h3 className="text-lg font-semibold text-foreground mb-3">2.7. Коммуникация между пользователями</h3>
            ...
            <section id="s3" className="scroll-mt-20 mb-10">
              <h2 className="text-xl font-semibold text-foreground mb-3">3. Информация, необходимая для установки и эксплуатации</h2>
            </section>

            <section id="s31" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">3.1. Модель распространения</h3>
            ...
            <section id="s32" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">3.2. Доступ к Платформе</h3>
            ...
            <section id="s33" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">3.3. Системные требования</h3>
              <ul className="space-y-1.5 text-foreground/80">
            ...
            <section id="s34" className="scroll-mt-20 mb-8">
              <h3 className="text-lg font-semibold text-foreground mb-3">3.4. Начало работы</h3>
            ...
            <section id="s35" className="scroll-mt-20 mb-10">
              <h3 className="text-lg font-semibold text-foreground mb-3">3.5. Техническая поддержка</h3>
