...
const SCHEDULE_STEPS = [
  ...
  },
  {
    ...
    desc: "В разделе «Мои события» нажми кнопку «Создать событие» и заполни карточку.",
    details: [
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center py-28">
          ...
          <p className="text-xl md:text-2xl text-white/80 font-light max-w-2xl mx-auto leading-relaxed">
            Пошаговое руководство по созданию, публикации и управлению событиями на платформе СПАРКОМ
          </p>
        </div>
      </section>
