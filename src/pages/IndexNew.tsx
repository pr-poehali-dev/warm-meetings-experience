...
const THEME_STYLES = `
  ...
  [data-sparcom-theme="dark"] {
    ...
    --bg-header:     rgba(20,16,12,0.75);
    --border-header: rgba(237,224,204,0.08);
    ...
    --login-btn-border: rgba(237,224,204,0.18);
  ...
  [data-sparcom-theme="light"] {
    ...
    --bg-header:     rgba(253,247,240,0.88);
    --border-header: rgba(200,131,74,0.12);
...
// ─── Стили стекла (через CSS-переменные) ─────────────────────────────────────
  ...
  return (
    <>
      ...
      >
        ...
        {/* ══ HEADER ═══════════════════════════════════════════════════════════ */}
        <header
          className="sticky top-0 z-50 px-4 py-3 transition-colors duration-500"
          style={{ background: "var(--bg-header)", backdropFilter: "blur(24px)", borderBottom: "1px solid var(--border-header)" }}
        >
          <div className="max-w-6xl mx-auto flex items-center gap-6">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm flex-1">
              {[["Афиша", "/events"], ["Мастера", "/masters"], ["Бани", "/baths"], ["Блог", "/blog"]].map(([l, h]) => (
                <Link key={h} to={h} className="hover:opacity-100 transition-opacity" style={{ color: "var(--c-nav)", opacity: 0.85 }}>{l}</Link>
              ))}
            </nav>
          ...
          {menuOpen && (
            <div className="md:hidden mt-3 rounded-2xl p-4 space-y-3 max-w-6xl mx-auto" style={glassCard}>
              {[["Афиша", "/events"], ["Мастера", "/masters"], ["Бани", "/baths"], ["Блог", "/blog"], ["Войти", "/login"]].map(([l, h]) => (
                <Link key={h} to={h} className="block text-sm py-1.5 border-b" style={{ color: "var(--c-cream)", borderColor: "var(--faq-border)" }} onClick={() => setMenuOpen(false)}>{l}</Link>
              ))}
            </div>
          )}
        </header>
        ...
        {/* ══ FOOTER ═══════════════════════════════════════════════════════════ */}
        <footer
          className="relative z-10 py-12 px-4 transition-colors duration-500"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row gap-10 justify-between mb-10">
              <div className="max-w-xs">
                ...
                />
                <p className="text-sm leading-relaxed" style={{ color: "var(--footer-link)" }}>
              ...
              <div className="flex flex-wrap gap-12">
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider mb-4" style={{ color: "var(--c-terra)", opacity: 0.8 }}>Проект</div>
                  <div className="space-y-2.5">
                    {[["Афиша", "/events"], ["Мастера", "/masters"], ["Бани", "/baths"], ["Блог", "/blog"], ["О нас", "/about"]].map(([l, h]) => (
                      <Link key={h} to={h} className="block text-sm transition-colors hover:opacity-100" style={{ color: "var(--footer-link)", opacity: 0.85 }}>{l}</Link>
                    ))}
                  </div>
                </div>
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider mb-4" style={{ color: "var(--c-terra)", opacity: 0.8 }}>Участникам</div>
                  <div className="space-y-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider mb-4" style={{ color: "var(--c-terra)", opacity: 0.8 }}>Организаторам</div>
                  <div className="space-y-2.5">
            ...
            >
              ...
              <div className="flex gap-5">
                <Link to="/documents?tab=privacy" className="hover:opacity-100 transition-opacity">Политика конфиденциальности</Link>
                <Link to="/documents?tab=terms" className="hover:opacity-100 transition-opacity">Условия использования</Link>
              </div>
            </div>
          </div>
        </footer>
