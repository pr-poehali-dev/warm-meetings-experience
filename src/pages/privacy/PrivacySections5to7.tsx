    ...
    <>
      ...
      <section id="ps8" className="scroll-mt-20">
        ...
        <div className="space-y-3 text-sm">
          ...
          <p>
            <strong>8.2.</strong> Администрация Сайта не сохраняет и не обрабатывает координаты выбранного Пользователем места. Вся информация о выбранной точке используется исключительно для отображения маркера на карте в рамках сессии.
          </p>
        </div>
      </section>
    </>
