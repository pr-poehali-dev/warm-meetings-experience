      ...
      <div className="space-y-6 text-sm">
        ...
        <div>
          ...
          <p className="leading-relaxed">
            ...
            Организаторам мероприятий, Мастерам, Управляющим (владельцам бань) на основании договора
    ...
    content: (
      <div className="space-y-6 text-sm">
        <p className="leading-relaxed">
          ...
          и лицом, получившим статус Организатора, Мастера или Управляющего на Сайте sparcom.ru (Поверенный).
        </p>
        <div>
